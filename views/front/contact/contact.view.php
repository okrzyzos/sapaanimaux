...
<p class="pl-5">
    <a href="" target=_blank><img src="public/sources/images/Autres/icones/facebook.png" width="30px" alt="Facebook"/></a>
    Suivez-nous sur facebook et participez à l'aventure de secourir aimer protéger nos Animaux : 
    <a href="" target=_blank><span class="badge badge-pill badge-primary">Notre facebook</span></a>
</p>
...
<div class="pl-5">
    <p>
        ...
        Par courrier : Hameau de la Souleille - 62000 Arras, Hauts de France, France
    </p>
    <p>
        <img src="<?=URL?>public/sources/images/Autres/icones/mail.png" width="30px" alt="mail"/>
        Par mail : <a href="mailto:okrzyzos@outlook.fr">associationsecouriraimerprotégernosanimaux@gmail.com</a>
    </p>
    <p>
        <img src="<?=URL?>public/sources/images/Autres/icones/tel.png" width="30px" alt="tel"/>
        Par téléphone : 06 10 54 94 75
    </p>
    <p>
...
isset($_POST['captcha']) && !empty($_POST['captcha'])
    ...
    if($captcha === 8){
        ...
        $destinataire = "okrzyzos@outlook.fr";
