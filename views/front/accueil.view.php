    ...
    <div class="carousel-inner ">
        <?php foreach($animaux as $key => $animal) : ?>
            <div class="carousel-item <?php echo ($key===0) ? "active" : ""?> ">
                <div class='row no-gutters border rounded overflow-hidden mb-4 perso_bgGreen'>
                    <div class='col-12 col-md-auto text-center'>
                        <img src ='public/sources/images/site/<?= $animal['image']['url_image'] ?>' style='height:250px;' alt='<?= $animal['image']['libelle_image'] ?>' />
                    </div>
...
<div class='row'>
    ...
    <div class='col-6 mt-3'>
        ...
        echo styleTitreNiveau2($txt,COLOR_ASSO);
        ?>
    </div>
</div>
<div class='row'>
    <div class='col-6'>
        <div class='row no-gutters border rounded mb-4'>
            <div class='col-auto d-none d-lg-block'>
                <img src ='public/sources/images/site/<?= $news['url_image'] ?>' style='height:190px;width:150px' alt='<?= $news['libelle_image'] ?>' />
    ...
    <div class='col-6'>
        <div class='row no-gutters border rounded mb-4'>
            <div class='col-auto d-none d-lg-block'>
            <img src ='public/sources/images/site/<?= $action['url_image'] ?>' style='height:190px;width:150px' alt='<?= $action['libelle_image'] ?>' />

            </div>
            <div class='col p-3 d-flew flex-column position-static perso_bgRose'>
